...
Loads preprocessed data, trains model, and saves to disk
"""
...
from config import (
    NGRAM_ORDER, MODEL_DIR, MODEL_FILE
)
...
def main():
    ...
    train_perplexity = model.perplexity(train_sentences[:1000])  # Sample for speed
    ...
    # Save test sentences for later evaluation
